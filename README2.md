...
1. L'utilisateur teste différents styles avec la main gauche.
2. Il applique un profil définitif avec la main droite.
3. Il déclenche la capture avec un pouce gauche.
4. Il valide l’impression avec un pouce droit.
...
Le système final respecte ces principes :

- Une fonction = un geste unique
- Une main = un rôle principal
- Aucun symbole partagé entre sélection et action système
